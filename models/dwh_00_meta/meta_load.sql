...
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_misc_kategorie_termintreue") }} where is_check_ok group by ldts  ) l
    ON 1=1
UNION ALL
SELECT 'load_roadshow_bestellung' as table_name, l.file_ldts, coalesce(l.rowcount, 0) as rowcount, ldts
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_roadshow_bestellung") }} where is_check_ok group by ldts  ) l
    ON 1=1
UNION ALL
SELECT 'load_webshop_bestellung' as table_name, l.file_ldts, coalesce(l.rowcount, 0) as rowcount, ldts
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_webshop_bestellung") }} where is_check_ok group by ldts  ) l
    ON 1=1
UNION ALL
SELECT 'load_webshop_kunde' as table_name, l.file_ldts, coalesce(l.rowcount, 0) as rowcount, ldts
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_webshop_kunde") }} where is_check_ok group by ldts  ) l
    ON 1=1
UNION ALL
SELECT 'load_webshop_lieferadresse' as table_name, l.file_ldts, coalesce(l.rowcount, 0) as rowcount, ldts
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_webshop_lieferadresse") }} where is_check_ok group by ldts  ) l
    ON 1=1
UNION ALL
SELECT 'load_webshop_lieferdienst' as table_name, l.file_ldts, coalesce(l.rowcount, 0) as rowcount, ldts
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_webshop_lieferdienst") }} where is_check_ok group by ldts  ) l
    ON 1=1
UNION ALL
SELECT 'load_webshop_lieferung' as table_name, l.file_ldts, coalesce(l.rowcount, 0) as rowcount, ldts
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_webshop_lieferung") }} where is_check_ok group by ldts  ) l
    ON 1=1
UNION ALL
SELECT 'load_webshop_position' as table_name, l.file_ldts, coalesce(l.rowcount, 0) as rowcount, ldts
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_webshop_position") }} where is_check_ok group by ldts  ) l
    ON 1=1
UNION ALL
SELECT 'load_webshop_produkt' as table_name, l.file_ldts, coalesce(l.rowcount, 0) as rowcount, ldts
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_webshop_produkt") }} where is_check_ok group by ldts  ) l
    ON 1=1
UNION ALL
...
FROM current_date 
LEFT JOIN (select ldts as file_ldts, count(*) as rowcount from {{ ref("load_webshop_wohnort") }} where is_check_ok group by ldts  ) l
    ON 1=1
